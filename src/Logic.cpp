...
void Logic::Load_Saved_Settings_Fans (){ // loaded once in void setup ONLY!!!
...
void Logic::check_and_save_data() {   // check if there is a change in the fans setup and control voltage
